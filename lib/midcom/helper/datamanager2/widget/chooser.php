...
class midcom_helper_datamanager2_widget_chooser extends midcom_helper_datamanager2_widget
{
    ...
    public function _on_initialize()
    {
        ...
        $head->add_jsfile(MIDCOM_STATIC_URL . '/midcom.extras.datamanager2/chooser/jquery.chooser_widget.js');
        $head->add_stylesheet(MIDCOM_STATIC_URL . '/midcom.extras.datamanager2/chooser/jquery.chooser_widget.css');
