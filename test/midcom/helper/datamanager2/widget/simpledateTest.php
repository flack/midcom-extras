...
require_once OPENPSA_TEST_ROOT . '../vendor/openpsa/midcom/test/midcom/helper/datamanager2/__helper/dm2.php';
...
class midcom_helper_datamanager2_widget_simpledateTest extends openpsa_testcase
{
    public function test_get_default()
    {
        ...
        $event = $this->create_object('org_openpsa_calendar_event_dba', array(
            'start' => $timestamp,
            'end' => $timestamp + 60 * 60
        ));
